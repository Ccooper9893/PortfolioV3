    ...
    return (
        ...
        <div className="hero-content p-0 flex-col-reverse lg:flex-row-reverse">
          ...
          <div className="text-center">
            ...
            <motion.p animate={{ x: 0, opacity: 1 }} initial={{ x: '0', opacity: 0 }} transition={{ delay: 5 }} className="text-2xl">I AM A 
              <motion.span animate={{ x: 0, opacity: 1 }} initial={{ x: '0', opacity: 0 }} transition={{ delay: 5.4 }} className="text-blue-400"> FULL STACK WEB DEVELOPER</motion.span>
            </motion.p>
