...
export default function Home({handlePageChange}) {
    return (
        ...
        <div className="hero-content p-0 flex-col-reverse lg:flex-row-reverse">
          ...
          <motion.img className="fade-in-4" animate={{ x: 0, opacity: 1 }} initial={{ x: '100vh', opacity: 0 }} transition={{ delay: 3 }} src={selfie} alt="Cody Cooper"/>
          <div className="text-center">

            <motion.h1 className="text-7xl mt-5 text-white" animate={{ x: 0, opacity: 1 }} initial={{ x: '0', opacity: 0 }} transition={{ delay: 0.3 }}>WELCOME!</motion.h1>

            <motion.p animate={{ x: 0, opacity: 1 }} initial={{ x: '0', opacity: 0 }} transition={{ delay: 1 }} className="py-3 text-4xl">MY NAME IS
              <motion.span animate={{ x: 0, opacity: 1 }} initial={{ x: '0', opacity: 0 }} transition={{ delay: 1.6 }} className="text-yellow-500"> CODY COOPER</motion.span>
            </motion.p>

            <motion.p animate={{ x: 0, opacity: 1 }} initial={{ x: '0', opacity: 0 }} transition={{ delay: 4.5 }} className="text-2xl">I AM A 
              <motion.span animate={{ x: 0, opacity: 1 }} initial={{ x: '0', opacity: 0 }} transition={{ delay: 5 }} className="text-blue-400"> FULL STACK WEB DEVELOPER</motion.span>
            </motion.p>
            ...
            <motion.button className='text-lg animate-pulse p-0 mt-3 hover:font-bold' onClick={() => handlePageChange('About')} animate={{ x: 0, opacity: 1 }} initial={{ x: -100, opacity: 0 }} transition={{ delay: 8 }}>Continue &#x2192;</motion.button>
