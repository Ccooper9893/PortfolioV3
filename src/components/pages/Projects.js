        ...
        <div className="mb-20 flex flex-col">
            ...
            <div className="flex flex-col lg:flex-row justify-center lg:mt-24 gap-6">
                ...
                <div className="flex justify-center my-10">
                    ...
                    <div className="modal">
                        <div className="modal-box bg-stone-900 border border-black">
                            <h3 className="text-6xl text-yellow-500 border-b border-yellow-400">Bring Popcorn</h3>
                            ...
                            <div className="modal-action justify-between">
                                <div className="flex flex-row gap-10 align-middle">
                                    ...
                                    <a className="opacity-70 hover:opacity-100" href="https://nbadraun.github.io/Bring-Popcorn/" target="_blank" rel="noopener noreferrer">
                                        <img className=" w-11" src={websiteIcon} alt="website link"></img>
                                    </a>
                                </div>
                                <label htmlFor="bringPopModal" className="btn bg-gray-300 text-black">Close</label>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="modal-box bg-stone-900 border border-black">
                            ...
                            <div className="modal-action justify-between">
                                <div className="flex flex-row gap-10 align-middle">
                                    ...
                                    <a className="opacity-70 hover:opacity-100" href="omega-blogs.herokuapp.com/" target="_blank" rel="noopener noreferrer">
                                        <img className=" w-11" src={websiteIcon} alt="website link"></img>
                                    </a>
                                </div>
                                <label htmlFor="omegaModal" className="btn bg-gray-300 text-black">Close</label>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex justify-center my-10">
                    ...
                    <div className="modal">
                        <div className="modal-box bg-stone-900 border border-black">
                            <h3 className="text-6xl text-yellow-500 border-b border-yellow-400">GetFit</h3>
                            <p className="py-4 text-xl text-white">
                            ...
                            <div className="modal-action justify-between">
                                <div className="flex flex-row gap-10 align-middle">
                                    ...
                                    <a className="opacity-70 hover:opacity-100" href="https://workout-planner.herokuapp.com/" target="_blank" rel="noopener noreferrer">
                                        <img className=" w-11" src={websiteIcon} alt="website link"></img>
                                    </a>
                                </div>
                                <label htmlFor="getFitModal" className="btn bg-gray-300 text-black">Close</label>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex justify-center my-10">
                    ...
                    <div className="modal">
                        <div className="modal-box bg-stone-900 border border-black">
                            <h3 className="text-6xl text-yellow-500 border-b border-yellow-400">J.A.T.E</h3>
                            <p className="py-4 text-xl text-white">
                            ...
                            <div className="modal-action justify-between">
                                <div className="flex flex-row gap-10 align-middle">
                                    ...
                                    <a className="opacity-70 hover:opacity-100" href="https://lit-island-48530.herokuapp.com/" target="_blank" rel="noopener noreferrer">
                                        <img className=" w-11" src={websiteIcon} alt="website Icon"></img>
                                    </a>
                                </div>
                                <label htmlFor="jateModal" className="btn bg-gray-300 text-black">Close</label>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="modal">
                        <div className="modal-box bg-stone-900 border border-black">
                            ...
                            <div className="modal-action justify-between ">
                                ...
                                <label htmlFor="apiModal" className="btn bg-gray-300 text-black">Close</label>
                            </div>
                        </div>
                    </div>
                </div>
