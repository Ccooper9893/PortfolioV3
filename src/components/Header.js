  ...
  return (
    <div className="navbar bg-base-100 shadow-lg">
      ...
      <div className="navbar-end">
        <a href="https://github.com/Ccooper9893" target="_blank" className="mx-2 hover:animate-pulse"><img className="w-6" src={githubLogo.toString()}></img></a>
        <a href="https://www.linkedin.com/in/cody-cooper-3a951a24b/" target="_blank" className="mx-3 hover:animate-spin"><img className="w-6" src={linkedLogo.toString()}></img></a>
      </div>
    </div>
  );
};
