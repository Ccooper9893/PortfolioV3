    ...
    <div className="navbar bg-base-100">
      <div className="navbar-start">
        <div className="dropdown z-10">
          ...
          <ul
            tabIndex={0}
            className="menu dropdown-content bg-gray-800 shadow rounded-box w-26"
          >
            <li>
              <button
      ...
      <div className="navbar-end">
        <a
          href="https://github.com/Ccooper9893"
        ...
        >
          <img
            className="w-6"
            alt="github link"
            src={githubLogo.toString()}
          ></img>
        </a>
        <a
          href="https://www.linkedin.com/in/cody-cooper-3a951a24b/"
          className="mx-3 hover:animate-spin"
          target="_blank"
          rel="noopener noreferrer"
        >
          <img
